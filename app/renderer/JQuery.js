...
function addReplacement() {
  ...
  $('#replacementsContainer')
    .append(`
  <div class="card" id="replacement-${replacementCounter}">
              <div class="card-header">
                <div class="float-right">
              ...
              <div class="card-body">
              <input class="card-text col-md-12 mb-2" id="whatToFind-${replacementCounter}" onblur="addReplacementToFile(${replacementCounter})" placeholder="What to find..."></input>
              <input class="card-text col-md-12" id="whatToReplace-${replacementCounter}" onblur="addReplacementToFile(${replacementCounter})" placeholder="What to replace with..."></input>
              </div>
            </div>
        </div>
`)
